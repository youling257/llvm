...
arm_asm_parser_TBLGEN_TABLES11 := \
  ARMGenInstrInfo.inc \
...
arm_asm_parser_TBLGEN_TD_DIR11 := $(LOCAL_PATH)/..
...
LOCAL_MODULE:= libLLVM11ARMAsmParser
LOCAL_MODULE_HOST_OS := darwin linux windows
LOCAL_SRC_FILES := $(arm_asm_parser_SRC_FILES)
LOCAL_C_INCLUDES += $(arm_asm_parser_C_INCLUDES)
TBLGEN_TABLES11 := $(arm_asm_parser_TBLGEN_TABLES11)
TBLGEN_TD_DIR11 := $(arm_asm_parser_TBLGEN_TD_DIR11)
