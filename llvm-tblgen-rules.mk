...
##########################################################
define transform-td-to-out11
$(if $(LOCAL_IS_HOST_MODULE),	\
	$(call transform-host-td-to-out11,$(1)),	\
	$(call transform-device-td-to-out11,$(1)))
endef
...
ifneq ($(strip $(TBLGEN_TABLES11)),)

generated_sources := $(call local-generated-sources-dir)
tblgen_gen_tables := $(addprefix $(generated_sources)/,$(TBLGEN_TABLES11))
LOCAL_GENERATED_SOURCES += $(tblgen_gen_tables)

tblgen_source_dir := $(LOCAL_PATH)
ifneq ($(TBLGEN_TD_DIR11),)
tblgen_source_dir := $(TBLGEN_TD_DIR11)
endif
...
#
ifeq ($(tblgen_source_dir),$(LLVM11_ROOT_PATH)/lib/Target/ARM/MCTargetDesc)
...
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
	...
	$(call transform-td-to-out11, register-info)
...
$(generated_sources)/%GenInstrInfo.inc: $(tblgen_source_dir)/../%.td \
                                    $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,instr-info)
...
$(generated_sources)/%GenSubtargetInfo.inc: $(tblgen_source_dir)/../%.td \
                                        $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,subtarget)
endif

ifeq ($(tblgen_source_dir),$(LLVM11_ROOT_PATH)/lib/Target/X86/MCTargetDesc)
$(generated_sources)/%GenRegisterInfo.inc: TBLGEN_LOCAL_MODULE := $(LOCAL_MODULE)
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
                                       $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11, register-info)
...
ifeq ($(tblgen_source_dir),$(LLVM11_ROOT_PATH)/lib/Target/Mips/MCTargetDesc)
$(generated_sources)/%GenRegisterInfo.inc: TBLGEN_LOCAL_MODULE := $(LOCAL_MODULE)
$(generated_sources)/%GenRegisterInfo.inc: $(tblgen_source_dir)/../%.td \
                                       $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11, register-info)
...
$(generated_sources)/%GenAsmWriter.inc: $(tblgen_source_dir)/%.td \
                                    $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,asm-writer)
endif
...
$(generated_sources)/%GenAsmWriter1.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,asm-writer -asmwriternum=1)
endif
...
$(generated_sources)/%GenAsmMatcher.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,asm-matcher)
endif
...
$(generated_sources)/%GenCodeEmitter.inc: $(tblgen_source_dir)/%.td \
                                      $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,emitter)
endif
...
$(generated_sources)/%GenMCPseudoLowering.inc: $(tblgen_source_dir)/%.td \
                                           $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,pseudo-lowering)
endif
...
$(generated_sources)/%GenDAGISel.inc: $(tblgen_source_dir)/%.td \
                                  $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,dag-isel)
endif
...
$(generated_sources)/%GenRegisterBank.inc: $(tblgen_source_dir)/%.td \
                                  $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,register-bank)
endif
...
$(generated_sources)/%GenDisassemblerTables.inc: $(tblgen_source_dir)/%.td \
                                             $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,disassembler)
endif
...
$(generated_sources)/%GenEDInfo.inc: $(tblgen_source_dir)/%.td \
                                 $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,enhanced-disassembly-info)
endif
...
$(generated_sources)/%GenFastISel.inc: $(tblgen_source_dir)/%.td \
                                   $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,fast-isel)
endif
...
$(generated_sources)/AMDGPUGenPreLegalizeGICombiner.inc: $(tblgen_source_dir)/AMDGPUGISel.td \
                                   $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,global-isel-combiner -combiners="AMDGPUPreLegalizerCombinerHelper")
endif
...
$(generated_sources)/AMDGPUGenPostLegalizeGICombiner.inc: $(tblgen_source_dir)/AMDGPUGISel.td \
                                   $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,global-isel-combiner -combiners="AMDGPUPostLegalizerCombinerHelper")
endif
...
$(generated_sources)/AMDGPUGenRegBankGICombiner.inc: $(tblgen_source_dir)/AMDGPUGISel.td \
                                   $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,global-isel-combiner -combiners="AMDGPURegBankCombinerHelper")
endif
...
$(generated_sources)/%GenCallingConv.inc: $(tblgen_source_dir)/%.td \
                                      $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,callingconv)
endif
...
$(generated_sources)/%GenIntrinsicEnums.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,intrinsic-enums)
endif
...
$(generated_sources)/%GenIntrinsicImpl.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,intrinsic-impl)
endif
...
$(generated_sources)/%GenSearchableTables.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,searchable-tables)
endif
...
$(generated_sources)/%GenDFAPacketizer.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) | $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,dfa-packetizer)
endif
...
$(generated_sources)/%GenExegesis.inc: $(tblgen_source_dir)/%.td \
                                     $(tblgen_td_deps) | $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,exegesis)
endif
...
$(generated_sources)/ARMGenDecoderTables.inc: $(tblgen_source_dir)/ARM.td \
                                          $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,arm-decoder)
endif
...
$(generated_sources)/Options.inc: $(tblgen_source_dir)/Options.td \
                                     $(tblgen_td_deps) \
                                     $(LLVM11_TBLGEN) \
                                     $(LLVM11_ROOT_PATH)/include/llvm/Option/OptParser.td
	$(call transform-td-to-out11,opt-parser-defs)
endif
...
$(generated_sources)/X86GenEVEX2VEXTables.inc: $(tblgen_source_dir)/X86.td \
                                          $(tblgen_td_deps) $(LLVM11_TBLGEN)
	$(call transform-td-to-out11,x86-EVEX2VEX-tables)
endif
